...
class GameJoltLogin extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('menuBG', 'preload'));
        ...
        charBop = new FlxSprite(-200, -100);
		charBop.frames = Paths.getSparrowAtlas('characters/CRASH', 'shared');
		charBop.animation.addByPrefix('idle', 'CRASH idle', 24);
		charBop.setGraphicSize(Std.int(charBop.width * 0.7));
        ...
        gamejoltText.font = Paths.font('crash-a-like.ttf');
        add(gamejoltText);
        ...
        {
            fancyOpenURL('https://www.youtube.com/watch?v=T5-x7kAGGnE');
        });
        ...
        if(GameJoltAPI.getStatus())
        {
            ...
            username.x += baseX;
            username.font = Paths.font('crash-a-like.ttf');
            add(username);
        }
    }
    ...
    override function update(elapsed:Float)
    {
        ...
        if (FlxG.mouse.overlaps(icon))
        {
            ...
            {
                fancyOpenURL('https://gamejolt.com');
            }
        }
