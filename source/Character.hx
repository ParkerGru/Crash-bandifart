	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				case 'crash':
				tex = Paths.getSparrowAtlas('CRASH','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'CRASH idle', 24);
				animation.addByPrefix('singUP', 'CRASH up', 24, false);
				animation.addByPrefix('singRIGHT', 'CRASH right', 24, false);
				animation.addByPrefix('singDOWN', 'CRASH down', 24, false);
				animation.addByPrefix('singLEFT', 'CRASH left', 24, false);
