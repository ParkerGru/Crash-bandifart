...
class Ratings
{
    public static function GenerateLetterRank(accuracy:Float) // generate a letter ranking
    {
        ...
        if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.shits == 0 && PlayState.goods == 0 && PlayState.sicks == 0) // WOAH! Full Combo
            ranking = "(WFC)";      
        else if (PlayState.misses == 0 && PlayState.bads == 0 && PlayState.shits == 0 && PlayState.goods == 0 && PlayState.sicks == 1) // Marvelous (SICK) Full Combo
            ranking = "(MFC)";
